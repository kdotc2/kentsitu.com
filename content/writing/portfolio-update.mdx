...
<div className="grid sm:grid-cols-2">
  <div className="sm:p-1">![Old Portfolio](/static/images/writing/old-portfolio.png)</div>
  <div className="sm:p-1">![New Portfolio](/static/images/writing/new-portfolio.png)</div>
</div>
