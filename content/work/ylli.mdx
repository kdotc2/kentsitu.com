...
<div className="grid grid-cols-1 md:grid-cols-2 pt-2 pb-3 gap-y-3 gap-x-3">
    <Image src="/images/work/ylli-item-card/tap-animation.gif" alt="Tap animation" width='709' height='112' />
    <Image src="/images/work/ylli-item-card/swipe-animation.gif" alt="Swipe animation" width='709' height='112' />
</div>
