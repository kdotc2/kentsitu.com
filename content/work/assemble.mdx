...
<div className="projectImageGrid">
    ...
    ![Home screen](/images/work/assemble/screen1.png)

    ![Create event screen](/images/work/assemble/screen2.png)

    ![Event detail screen](/images/work/assemble/screen3.png)

    ![Share screen](/images/work/assemble/screen4.png)
