...
<div className="projectImageGrid">
    ![Inventory home screen](/static/images/work/ylli/screen1.png)

    ![Search inventory screen](/static/images/work/ylli/screen2.png)

    ![Category filter screen](/static/images/work/ylli/screen3.png)

    ![Sort items by screen](/static/images/work/ylli/screen4.png)
</div>
...
<div className="projectImageGrid">
    ![Total spend screen](/static/images/work/ylli/screen5.png)

    ![Item breakdown screen](/static/images/work/ylli/screen6.png)

    ![Spend category breakdown screen](/static/images/work/ylli/screen7.png)

    ![Filter report by screen](/static/images/work/ylli/screen8.png)
</div>
...
<div className="projectImageGrid">
    ![Add item screen](/static/images/work/ylli/screen9.png)

    ![Select category screen](/static/images/work/ylli/screen10.png)

    ![Select expiration date screen](/static/images/work/ylli/screen11.png)

    ![Completed info screen](/static/images/work/ylli/screen12.png)
</div>

- More control for users by letting them allow/not allow access to camera and photos. Used OCR (Optical character recognition) to help add default images to items in receipt scans.
<div className="projectImageGrid">
    ![Camera access screen](/static/images/work/ylli/screen13.png)

    ![Receipt scan screen](/static/images/work/ylli/screen14.png)

    ![Photo access screen](/static/images/work/ylli/screen15.png)

    ![Scanned items screen](/static/images/work/ylli/screen16.png)
</div>
...
<div className="projectImageGrid">
    ...
    ![Sort items filter screen](/static/images/work/ylli/handoff1.png)

    ![Category filters screen](/static/images/work/ylli/handoff2.png)

    ![Swipe actions screen](/static/images/work/ylli/handoff3.png)
    
    ![Edit info screen](/static/images/work/ylli/handoff4.png)
