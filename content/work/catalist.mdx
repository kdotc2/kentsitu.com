...
<div className="grid grid-cols-1 sm:grid-cols-2 py-6 gap-4">
  ...
  <VideoPlayer link="/videos/catalist.mp4" poster="/videos/catalist-poster.png" width="224" phone />
</div>
...
<div className="py-4">
  ...
  ![Top 4 categories out of 13](/images/work/catalist/survey.png)
...
<div className="py-4">![12 Competitor products](/images/work/catalist/competitors.png)</div>
...
<div className="py-4">![Competitor analysis](/images/work/catalist/competitor-analysis.png)</div>
...
<div className="py-4">![Sitemap](/images/work/catalist/sitemap.png)</div>
...
<div className="py-4">![User flow](/images/work/catalist/user-flow.png)</div>
...
<div className="projectImageGrid pt-4">
    ...
    ![Discover screen](/images/work/catalist/wireframe1.png)

    ![List screen](/images/work/catalist/wireframe2.png)

    ![Item screen](/images/work/catalist/wireframe3.png)

    ![Create list screen](/images/work/catalist/wireframe4.png)

    ![Favorites - list screen](/images/work/catalist/wireframe5.png)

    ![Inbox - notifications screen](/images/work/catalist/wireframe6.png)

    ![Inbox - messages screen](/images/work/catalist/wireframe7.png)

    ![Profile screen](/images/work/catalist/wireframe8.png)
...
<div className="projectImageGrid pt-4">
  ...
  ![Concept 1 screen](/images/work/catalist/concept1.png)

  ![Concept 2 screen](/images/work/catalist/concept2.png)

  ![Concept 3 screen](/images/work/catalist/concept3.png)

  ![Concept 4 screen](/images/work/catalist/concept4.png)
...
<div className="projectImageGrid pt-4">
  ...
  ![Welcome screen](/images/work/catalist/screen1.png)

  ![Apple signin screen](/images/work/catalist/screen2.png)

  ![Google signin screen](/images/work/catalist/screen3.png)

  ![Enter info screen](/images/work/catalist/screen4.png)
...
<div className="projectImageGrid pt-4">
  ...
  ![Create list screen](/images/work/catalist/screen9.png)

  ![Search item screen](/images/work/catalist/screen10.png)

  ![Adding items screen](/images/work/catalist/screen11.png)

  ![Edit list screen](/images/work/catalist/screen12.png)
...
![Discover components screen](/images/work/catalist/mvp-features.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Discover screen](/images/work/catalist/screen13.png)

    ![List view screen](/images/work/catalist/screen14.png)

    ![Item view screen](/images/work/catalist/screen15.png)

    ![Create list screen](/images/work/catalist/screen16.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Discover components screen](/images/work/catalist/components1.png)

    ![List view components screen](/images/work/catalist/components2.png)

    ![Item view components screen](/images/work/catalist/components3.png)

    ![Create list components screen](/images/work/catalist/components4.png)
...
<div className="space-y-2.5 pb-1">
  <div className="flex items-center">
    <span>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF8300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-1 mr-2 h-5 w-5"><circle cx="12" cy="8" r="5"/><path d="M20 21a8 8 0 0 0-16 0"/></svg>
    </span>
    <span className="tabular-nums"><span className="font-bold">43%</span> DAU/WAU ratio.</span>
  </div>

  <div className="flex items-center">
    <span>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF8300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-1 mr-2 h-5 w-5"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 9H8"/><path d="M16 13H8"/><path d="M16 17H8"/></svg>
    </span>
    <span className="tabular-nums"><span className="font-bold">41%</span> of users created at least one list.</span>
  </div>

  <div className="flex items-center">
    <span>
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF8300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-1 mr-2 h-5 w-5"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" x2="19" y1="8" y2="14"/><line x1="22" x2="16" y1="11" y2="11"/></svg>
    </span>
    <span className="tabular-nums"><span className="font-bold">33%</span> of users followed at least one list.</span>
  </div>

    <div className="flex items-center">
    <span>
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF8300" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mx-1 mr-2 h-5 w-5"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="m9 15 2 2 4-4"/></svg>
    </span>
    <span className="tabular-nums"><span className="font-bold">29%</span> of users completed at least one item.</span>
  </div>
</div>
