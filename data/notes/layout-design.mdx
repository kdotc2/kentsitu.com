...
There's three different categories: work, notes, and about. When hovered/active, there's a rounded rectangle background. On mobile, the three categories disappear and a hamburger menu takes its place. The hamburger menu slides out with the three categories.

### Footer

The footer helps tuck away useful information. I don't expect these sections to get clicked on that often. When hovered over, the text color changes depending on the theme. On mobile, the right section stacks on top of the left section.
