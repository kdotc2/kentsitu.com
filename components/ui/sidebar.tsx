...
const SidebarGroupLabel = ({
  ...
  return (
    <Comp
      ...
      className={cn(
        'duration-200 flex h-8 shrink-0 items-center rounded-md px-3 text-xs font-medium text-sidebar-foreground/80 outline-hidden ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
