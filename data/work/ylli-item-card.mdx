...
First—redesign the inventory item card to provide flexibility for our long-term roadmap. Second—make it easier to move items to expense report. Third—create a tutorial to guide users on the new changes.
...
<div className="grid grid-cols-1 sm:grid-cols-2">
  <div className="m-auto mx-4">
    <h2 className="text-3xl text-[#59A4F5] font-medium">Item Card Updates</h2>
    Swipe right to mark item as finished.<br />
    Swipe left to mark item as expired.<br />
    Tap card to open item info screen.<br />
    Tap 'Delete Item' to delete card.<br />Tap 'Undo' to revert changes.
  </div>
  <div className="">
...
<div className="grid grid-cols-1 py-8 sm:grid-cols-2">
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-8">
  <div className="m-auto mx-4">
    <h2 className="text-3xl text-[#59A4F5] font-medium">Updated tutorial</h2>
    Added swipe and tap animations.<br />
    Added worded description for each step.
  </div>
  <div className="mx-20 items-center md:mx-20">
...
During implementation, the team decided not to implement all the changes. First—instead of having users go through each step of the tutorial, we created a video to speed up some of the process. Second—due to timing, we didn't update the undo button and left it as it was in the previous design. Third—the delete button wasn't implemented in this iteration.
...
<div className="grid grid-cols-3 gap-24 text-center py-8">
  <div className="py-10">
...
<div className="keyTakeaways">
  <span className="font-semibold">Tradeoffs and disagreements will occur.</span> The goal is to get
  on the same page through compromise. Then come up with the best path forward.
</div>

<div className="keyTakeaways">
  <span className="font-semibold">It's okay if production doesn't match handoff.</span> Priorities
