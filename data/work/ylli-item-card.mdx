...
<div className="grid grid-cols-1 sm:grid-cols-2">
  ...
  <div className="py-8">
  <Video link="/static/videos/item-card-updates.mp4" poster="/static/videos/item-card-updates-poster.png" />
  </div>
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2">
  <div className="m-auto">
    ...
    <div className="py-8">
      <Video link="/static/videos/updated-tutorial.mp4" poster="/static/videos/updated-tutorial-poster.png" />
    </div>
</div>
...
<div className="grid grid-cols-3 gap-24 text-center pb-8">
  <div className="py-10">
