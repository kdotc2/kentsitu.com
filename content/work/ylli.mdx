...
<div className="py-4">
  ![Food waste stats](/images/work/ylli/chart1.png)
...
<div className="py-4">
  ![More food waste stats](/images/work/ylli/chart2.png)
  <div className="text-xs text-center">
    Source:{' '}
    <a
...
<div className="py-4">![Competitors and features](/images/work/ylli/competitors.png)</div>
...
<div className="py-4">![User flow](/images/work/ylli/user-flow.png)</div>
...
<div className="projectImageGrid pt-4">
    ...
    ![Inventory screen](/images/work/ylli/wireframe1.png)

    ![Item info screen](/images/work/ylli/wireframe2.png)

    ![Swipe actions screen](/images/work/ylli/wireframe3.png)

    ![Notifications screen](/images/work/ylli/wireframe4.png)

    ![Report screen](/images/work/ylli/wireframe5.png)

    ![Add item options screen](/images/work/ylli/wireframe6.png)

    ![Search item screen](/images/work/ylli/wireframe7.png)

    ![Edit info screen](/images/work/ylli/wireframe8.png)
...
<div className="py-4">![User interviews](/images/work/ylli/user-interviews.png)</div>
...
<div className="projectImageGrid pt-4">
  ...
  ![Search inventory screen](/images/work/ylli/screen2.png)

  ![Category filter screen](/images/work/ylli/screen3.png)

  ![Sort items by screen](/images/work/ylli/screen4.png)
...
<div className="projectImageGrid pt-4">
  ...
  ![Item breakdown screen](/images/work/ylli/screen6.png)

  ![Spend category breakdown screen](/images/work/ylli/screen7.png)

  ![Filter report by screen](/images/work/ylli/screen8.png)
...
<div className="projectImageGrid pt-4">
  ...
  ![Add item screen](/images/work/ylli/screen9.png)

  ![Select category screen](/images/work/ylli/screen10.png)

  ![Select expiration date screen](/images/work/ylli/screen11.png)
...
<div className="projectImageGrid pt-4">
  ...
  ![Camera access screen](/images/work/ylli/screen13.png)

  ![Receipt scan screen](/images/work/ylli/screen14.png)

  ![Photo access screen](/images/work/ylli/screen15.png)

  ![Scanned items screen](/images/work/ylli/screen16.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Sort items filter screen](/images/work/ylli/handoff1.png)

    ![Category filters screen](/images/work/ylli/handoff2.png)

    ![Swipe actions screen](/images/work/ylli/handoff3.png)

    ![Edit info screen](/images/work/ylli/handoff4.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Camera scan screen](/images/work/ylli-receipt-scan/screen1.png)

    ![Review photos screen](/images/work/ylli-receipt-scan/screen2.png)

    ![Scan error screen](/images/work/ylli-receipt-scan/screen3.png)

    ![Items found screen](/images/work/ylli-receipt-scan/screen4.png)
...
![User flow](/images/work/ylli-receipt-scan/user-flow.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Brightness error screen](/images/work/ylli-receipt-scan/screen5.png)

    ![Adjust receipt error screen](/images/work/ylli-receipt-scan/screen6.png)

    ![Updated brightness error screen](/images/work/ylli-receipt-scan/screen7.png)

    ![Updated adjust receipt error screen](/images/work/ylli-receipt-scan/screen8.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Updated items found screen](/images/work/ylli-receipt-scan/screen9.png)

    ![Select purchase date screen](/images/work/ylli-receipt-scan/screen10.png)

    ![Add item screen](/images/work/ylli-receipt-scan/screen11.png)

    ![Completed items found screen](/images/work/ylli-receipt-scan/screen12.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Concept 1 screen](/images/work/ylli-item-card/concept1.png)

    ![Concept 2 screen](/images/work/ylli-item-card/concept2.png)

    ![Final concept screen](/images/work/ylli-item-card/concept3.png)

    ![Undo action screen](/images/work/ylli-item-card/concept4.png)
...
<div className="projectImageGrid">
    ...
    ![Beginning of tutorial screen](/images/work/ylli-item-card/screen1.png)

    ![Search to add tutorial screen](/images/work/ylli-item-card/screen2.png)
  
    ![Search for "orange" tutorial screen](/images/work/ylli-item-card/screen3.png)
  
    ![Item added tutorial screen](/images/work/ylli-item-card/screen4.png)
  
    ![Swipe right tutorial screen](/images/work/ylli-item-card/screen5.png)
  
    ![Swipe left tutorial screen](/images/work/ylli-item-card/screen6.png)
  
    ![Tap card tutorial screen](/images/work/ylli-item-card/screen7.png)
  
    ![Delete card tutorial screen](/images/work/ylli-item-card/screen8.png)
...
The general consensus among the stakeholders was that the new design was smoother. It provided us with more flexibility to add new features. The work in progress features below include—reminders, groups, storage filters, and multi-select. Before implementation, we wanted to make sure this new card design could scale with our roadmap.
 ...
 <div className="projectImageGrid pt-4">
    ...
    ![Concept 1 screen](/images/work/ylli-item-card/concept5.png)

    ![Concept 2 screen](/images/work/ylli-item-card/concept6.png)

    ![Final concept screen](/images/work/ylli-item-card/concept7.png)

    ![Undo action screen](/images/work/ylli-item-card/concept8.png)
...
<div className="projectImageGrid pt-4">
    ...
    ![Concept 1 screen](/images/work/ylli-item-card/screen9.png)
  
    ![Concept 2 screen](/images/work/ylli-item-card/screen10.png)
  
    ![Final concept screen](/images/work/ylli-item-card/screen11.png)
  
    ![Undo action screen](/images/work/ylli-item-card/screen12.png)
...
But we did see a jump from 28% to 72%. While the redesign looks successful early on, we still need to continue monitoring.
