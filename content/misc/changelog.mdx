...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">February 1, 2025 </div>

Updated to Next.js 15.1.6 
- Redesigned layout and updated colors.
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">January 23, 2025 </div>
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">August 23, 2024 </div>
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">July 07, 2024 </div>
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">December 24, 2023 </div>
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">July 16, 2023 </div>
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">January 07, 2023 </div>
...
<div className="font-mono text-sm text-gray-500 dark:text-gray-400">January 01, 2023 </div>
