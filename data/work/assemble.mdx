...
<div className="md:pt-8">![Home screen updates](/static/images/assemble/updates1.png)</div>

<div>![Create an event screen updates](/static/images/assemble/updates2.png)</div>

<div>![View event screen updates](/static/images/assemble/updates3.png)</div>
...
<div className="keyTakeaways">
  1. <span className="font-semibold">Pivot and adapt to the situation.</span> Each project has
  different goals and resources. Figure out what's important and prioritize process around the
  situation.
</div>

<div className="keyTakeaways">
  2. <span className="font-semibold">Be confident with research data.</span> Expect pushback and
  disagreements along the way. Data-backed, decision-making speaks louder than words.
</div>

<div className="keyTakeaways">
  3. <span className="font-semibold">Compromising is very important.</span> Things will not always go
