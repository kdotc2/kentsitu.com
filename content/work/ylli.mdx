...
<div className="grid grid-cols-1 sm:grid-cols-2 pt-6 gap-4">
  ...
  <VideoPlayer title="ylli" poster="/images/ylli-poster.webp" width={224} phone />
</div>
...
<div className="py-4">
  <Image src="/images/work/ylli/chart1.webp" alt="Food waste stats" width='1344' height='593' />
...
<div className="py-4">
  <Image src="/images/work/ylli/chart2.webp" alt="More food waste stats" width='1200' height='412' />
  <div className="text-xs text-center">
    Source:{' '}
    <a
...
<div className="py-4">
  <Image src="/images/work/ylli/competitors.webp" alt="Competitors and features" width='1900' height='844' />
</div>
...
<div className="py-4">
  <Image src="/images/work/ylli/user-flow.webp" alt="User flow" width='3528' height='2256' />
</div>
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli/wireframe1.webp" alt="Inventory screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe2.webp" alt="Item info screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe3.webp" alt="Swipe actions screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe4.webp" alt="Notifications screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe5.webp" alt="Report screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe6.webp" alt="Add item options screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe7.webp" alt="Search item screen" width='375' height='812' />

    <Image src="/images/work/ylli/wireframe8.webp" alt="Edit info screen" width='375' height='812' />
...
<div className="py-4">
  <Image src="/images/work/ylli/user-interviews.webp" alt="User interviews" width='1146' height='868' />
</div>
...
<div className="projectImageGrid pt-4">
  ...
  <Image src="/images/work/ylli/screen1.webp" alt="Inventory home screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen2.webp" alt="Search inventory screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen3.webp" alt="Category filter screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen4.webp" alt="Sort items by screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
  ...
  <Image src="/images/work/ylli/screen5.webp" alt="Total spend screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen6.webp" alt="Item breakdown screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen7.webp" alt="Spend category breakdown screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen8.webp" alt="Filter report by screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
  ...
  <Image src="/images/work/ylli/screen9.webp" alt="Add item screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen10.webp" alt="Select category screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen11.webp" alt="Select expiration date screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen12.webp" alt="Completed info screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
  ...
  <Image src="/images/work/ylli/screen13.webp" alt="Camera access screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen14.webp" alt="Receipt scan screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen15.webp" alt="Photo access screen" width='375' height='812' />

  <Image src="/images/work/ylli/screen16.webp" alt="Scanned items screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli/handoff1.webp" alt="Sort items filter screen" width='375' height='812' />

    <Image src="/images/work/ylli/handoff2.webp" alt="Category filters screen" width='375' height='812' />

    <Image src="/images/work/ylli/handoff3.webp" alt="Swipe actions screen" width='375' height='812' />

    <Image src="/images/work/ylli/handoff4.webp" alt="Edit info screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-item-card/tutorial1.webp" alt="Click to add items tutorial screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/tutorial2.webp" alt="Added first item tutorial screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/tutorial3.webp" alt="Swipe for more actions tutorial screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/tutorial4.webp" alt="Available options tutorial screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-item-card/concept1.webp" alt="Concept 1 screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/concept2.webp" alt="Concept 2 screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/concept3.webp" alt="Final concept screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/concept4.webp" alt="Undo action screen" width='375' height='812' />
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-6 gap-4">
  ...
  <VideoPlayer title="ylli-item-card-updates" poster="/images/ylli-item-card-updates-poster.webp" width={224} phone />
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 pt-2 pb-3 gap-y-3 gap-x-3">
    <Image src="/images/work/ylli-item-card/tap-animation.gif" alt="Tap animation" width='709' height='112' unoptimized />
    <Image src="/images/work/ylli-item-card/swipe-animation.gif" alt="Swipe animation" width='709' height='112' unoptimized />
</div>

<div className="projectImageGrid">
  
    <Image src="/images/work/ylli-item-card/screen1.webp" alt="Beginning of tutorial screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/screen2.webp" alt="Search to add tutorial screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen3.webp" alt="Search for orange tutorial screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen4.webp" alt="Item added tutorial screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen5.webp" alt="Swipe right tutorial screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen6.webp" alt="Swipe left tutorial screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen7.webp" alt="Tap card tutorial screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen8.webp" alt="Delete card tutorial screen" width='375' height='812' />
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-6 gap-4">
  ...
  <VideoPlayer title="ylli-updated-tutorial" poster="/images/ylli-updated-tutorial-poster.webp" width={224} phone />
</div>
...
The general consensus among the stakeholders was that the new design was smoother. It provided us with more flexibility to add new features. The work in progress features below include—reminders, groups, storage filters, and multi-select. Before implementation, we wanted to make sure this new card design could scale with our roadmap.
 ...
 <div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-item-card/concept5.webp" alt="Concept 1 screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/concept6.webp" alt="Concept 2 screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/concept7.webp" alt="Final concept screen" width='375' height='812' />

    <Image src="/images/work/ylli-item-card/concept8.webp" alt="Undo action screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-item-card/screen9.webp" alt="Concept 1 screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen10.webp" alt="Concept 2 screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen11.webp" alt="Final concept screen" width='375' height='812' />
  
    <Image src="/images/work/ylli-item-card/screen12.webp" alt="Undo action screen" width='375' height='812' />
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-receipt-scan/screen1.webp" alt="Camera scan screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen2.webp" alt="Review photos screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen3.webp" alt="Scan error screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen4.webp" alt="Items found screen" width='375' height='812' />
...
<Image src="/images/work/ylli-receipt-scan/user-flow.webp" alt="User flow" width='1724' height='883' />
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-receipt-scan/screen5.webp" alt="Brightness error screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen6.webp" alt="Adjust receipt error screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen7.webp" alt="Updated brightness error screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen8.webp" alt="Updated adjust receipt error screen" width='375' height='812' />

</div>

I also made some updates to the second part of the scan flow. These features were missing in the first launch. And it made the scan difficult for users to complete. The item card was redesigned from the project above.
...
<div className="projectImageGrid pt-4">
    ...
    <Image src="/images/work/ylli-receipt-scan/screen9.webp" alt="Updated items found screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen10.webp" alt="Select purchase date screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen11.webp" alt="Add item screen" width='375' height='812' />

    <Image src="/images/work/ylli-receipt-scan/screen12.webp" alt="Completed items found screen" width='375' height='812' />
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4">
  ...
  <VideoPlayer title="ylli-receipt-scan" poster="/images/ylli-receipt-scan-poster.webp" width={224} phone />
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4">
  ...
  <VideoPlayer title="ylli-receipt-error-handling" poster="/images/ylli-receipt-error-handling-poster.webp" width={224} phone/>
</div>
