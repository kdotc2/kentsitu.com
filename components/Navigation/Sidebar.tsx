...
function Sidebar() {
  ...
  return (
    <div
      className={`sticky top-0 z-[40] hidden flex-shrink-0 flex-col overflow-y-auto bg-gray-100 dark:bg-[#212121] md:flex md:h-[calc(100vh)] lg:h-screen ${'w-[180px] lg:w-[240px]'}`}
    >
      <AnimatePresence>
