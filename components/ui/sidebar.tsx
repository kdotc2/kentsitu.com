    ...
    >
      ...
      >
        <div
          ...
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm group-data-[collapsible=icon]:px-0"
        >
          {children}
        </div>
      </div>
...
const SidebarGroupLabel = ({
  ...
  return (
    <Comp
      ...
      className={cn(
        'duration-200 flex h-8 shrink-0 items-center rounded-md px-3 text-xs font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
  ...
  ],
  {
    variants: {
      variant: {
        ...
        outline:
          'border bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]',
      ...
      size: {
        ...
        icon: 'size-8 rounded-full flex justify-center items-center',
      },
    },
    defaultVariants: {
      variant: 'default',
...
const SidebarMenuButton = ({
  ...
  const { key, ...tooltipRest } = tooltipProps
