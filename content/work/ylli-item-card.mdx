...
<div className="grid grid-cols-1 gap-4 py-6 sm:grid-cols-2">
  <div className="m-auto pb-0 sm:pb-4">
    <div className="text-lg font-semibold text-[#59A4F5]">Item Card Updates</div>- Swipe right to
    mark item as finished. - Swipe left to mark item as expired. - Tap card to open item info
    screen. - Tap 'Delete Item' to delete card. - Tap 'Undo' to revert changes.
  </div>
  <VideoPlayer
    link="/static/videos/ylli-item-card-updates.mp4"
    poster="/static/videos/ylli-item-card-updates-poster.png"
  />
</div>
...
<div className="grid grid-cols-1 gap-4 py-6 sm:grid-cols-2">
  <div className="m-auto pb-0 sm:pb-4">
    <div className="text-lg font-semibold text-[#59A4F5]">Tutorial Updates</div>- Added swipe and
    tap animations. - Added worded description for each step.
  </div>
  <VideoPlayer
    link="/static/videos/ylli-updated-tutorial.mp4"
    poster="/static/videos/ylli-updated-tutorial-poster.png"
  />
</div>
...
<div className="py-4 md:mx-20">
  ![Test results](/static/images/work/ylli-item-card/test-results.png)
</div>
...
The general consensus among the stakeholders was that the new design was smoother. It provided us with more flexibility to add new features. The work in progress features below include—reminders, groups, storage filters, and multi-select. Before implementation, we wanted to make sure this new card design could scale with our roadmap.
 ...
 <div className="projectImageGrid">
    ...
    ![Concept 1 screen](/static/images/work/ylli-item-card/concept5.png)

    ![Concept 2 screen](/static/images/work/ylli-item-card/concept6.png)

    ![Final concept screen](/static/images/work/ylli-item-card/concept7.png)

    ![Undo action screen](/static/images/work/ylli-item-card/concept8.png)
...
<div className="py-4 text-center text-lg font-bold">Users moving items to expense report</div>
...
<div className="keyTakeaways">
  1. <span className="font-semibold">Tradeoffs and disagreements will occur.</span> The goal is to
  get on the same page through compromise. Then come up with the best path forward.
</div>

<div className="keyTakeaways">
  2. <span className="font-semibold">It's okay if production doesn't match handoff.</span>{' '}
  Priorities and designs are always shifting. Document the inconsistencies and advocate for them to
  get fixed.
</div>
