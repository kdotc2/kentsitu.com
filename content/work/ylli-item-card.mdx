...
<div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4">
  ...
  <VideoPlayer link="/static/videos/ylli-item-card-updates.mp4" poster="/static/videos/ylli-item-card-updates-poster.png" />
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4">
  ...
  <VideoPlayer link="/static/videos/ylli-updated-tutorial.mp4" poster="/static/videos/ylli-updated-tutorial-poster.png" />
</div>
