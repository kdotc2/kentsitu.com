...
The team decided not to implement all the changes. We felt that delaying both the undo and delete was the right call as it wasn't high on our priorities. For developer handoff, we used Adobe XD's specs and commenting. For the animations, we used Lottie Files.
...
<div className="projectImageGrid">
  <div className="imageProp">
    ![Concept 1 screen](/static/images/ylli-item-card/screen9.png)
  </div>
  <div className="imageProp">
    ![Concept 2 screen](/static/images/ylli-item-card/screen10.png)
  </div>
  <div className="imageProp">
    ![Final concept screen](/static/images/ylli-item-card/screen11.png)
  </div>
  <div className="imageProp">
    ![Undo action screen](/static/images/ylli-item-card/screen12.png)
  </div>
</div>
