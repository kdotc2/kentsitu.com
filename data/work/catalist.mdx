...
The team consisted of three people. I worked with a product manager, and a developer to build the product. My role was Product Designer. I designed, prototyped, and tested the designs. I collaborated with the product manager and developer on research and implementation. We launched our MVP in the App Store. The project took five months to complete.
...
We decided to put more emphasis on the list format, as opposed to the individual interest types our competitors focused on. We found that a list format could potentially solve our pain points above. I put together a sitemap and user flow to organize our idea. There are two options the user can go towards, creating a new list or discovering lists.

<div className="pt-8 pb-4">![Sitemap](/static/images/catalist/sitemap.png)</div>

<div className="pt-4 pb-8">![User flow](/static/images/catalist/user-flow.png)</div>
