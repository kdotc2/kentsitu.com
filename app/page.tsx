...
export default function Home() {
  return (
    <AnimateEnter>
      <div className="flex items-center justify-center px-6 supports-[height:100dvh]:h-[calc(100dvh-64px)] sm:h-[calc(100vh-84px)] md:h-[calc(100vh-40px)] lg:h-[calc(100vh-80px)]">
