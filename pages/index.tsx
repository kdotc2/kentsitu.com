...
export default function index() {
  return (
    <>
      ...
      <div className="flex sm:h-[calc(100vh-60px)] supports-[height:100cqh]:h-[calc(100cqh-60px)] supports-[height:100svh]:h-[calc(100svh-60px)] items-center justify-center px-6">
