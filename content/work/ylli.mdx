...
<div className="projectImageGrid">
  <Image src="/images/work/ylli/screen1.png" alt="Inventory home screen" width='375' height='812' loading="eager" />
  <Image src="/images/work/ylli/screen5.png" alt="Total spend screen" width='375' height='812' loading="eager" />
  <Image src="/images/work/ylli/screen12.png" alt="Completed info screen" width='375' height='812' loading="eager" />
  <Image src="/images/work/ylli/screen15.png" alt="Photo access screen screen" width='375' height='812' loading="eager" />
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 pt-6 gap-4">
  ...
  <VideoPlayer link="/videos/ylli.mp4" poster="/videos/ylli-poster.png" phone width="224" />
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4">
  ...
  <VideoPlayer link="/videos/ylli-receipt-scan.mp4" poster="/videos/ylli-receipt-scan-poster.png" phone width="224" />
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-4 gap-4">
  ...
  <VideoPlayer link="/videos/ylli-receipt-error-handling.mp4" poster="/videos/ylli-receipt-error-handling-poster.png" phone width="224"/>
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-6 gap-4">
  ...
  <VideoPlayer link="/videos/ylli-item-card-updates.mp4" poster="/videos/ylli-item-card-updates-poster.png" phone width="224" />
</div>
...
<div className="grid grid-cols-1 sm:grid-cols-2 py-6 gap-4">
  ...
  <VideoPlayer link="/videos/ylli-updated-tutorial.mp4" poster="/videos/ylli-updated-tutorial-poster.png" phone width="224" />
</div>
