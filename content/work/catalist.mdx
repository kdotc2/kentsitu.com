...
{' '}
<div className="text-center text-xs">Top 4 categories from a list of 13 from the survey</div>
...
<div className="py-4">
  ![Competitor analysis](/static/images/work/catalist/competitor-analysis.png)
</div>
...
<div className="grid grid-cols-1 gap-4 py-6 sm:grid-cols-2">
  <div className="m-auto pb-0 sm:pb-4">
    <div className="flex py-2">
      <Button
        link="https://www.figma.com/proto/WHJWY7oH3GPv2ytojmFueg/Catalist"
        text="Updated Prototype"
      />
    </div>
    - Sign up through a guided process. - View list and individual items. - Create lists and make
    edits. - Filter the discover feed. - Check notifications and start a chat.
  </div>
...
<div className="grid grid-cols-2 gap-x-2 text-center md:grid-cols-4">
  <div className="py-4">
...
<div className="keyTakeaways">
  1. <span className="font-semibold">Building a product from zero to one is tough.</span> There
  needs to be a good understanding of the domain and its competitors. It requires a lot of research
  and learning things that might not be design-related.
</div>
