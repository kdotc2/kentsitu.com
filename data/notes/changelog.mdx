...
The first problem was figuring out how to make the home page a one pager without scroll. Did some research and found that using `100vh` (viewport, height of browser) minus the navBar helped solve the issue.

```js
// height for my navBar is 60px

h-[calc(100vh-60px)] // used for home page to create a responsive page without a scroll
```
