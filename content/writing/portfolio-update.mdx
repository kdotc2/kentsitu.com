...
_Updated to 2.0 (current site), the old design can be found <a href={'/projects/portfolio'}>here</a>._
...
<div className="grid gap-3 py-4 sm:grid-cols-2">
  <div>![Old Portfolio](/static/images/writing/portfolio-updates/old-portfolio.png)</div>
  <div>![New Portfolio](/static/images/writing/portfolio-updates/new-portfolio.png)</div>
</div>
