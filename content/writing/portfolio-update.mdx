...
_Updated to 2.0 (current site), the old portfolio can be found [here](https://v1.kentsitu.com)._
...
<div className="grid sm:grid-cols-2">
  <div className="sm:p-1">![Old Portfolio](/static/images/writing/portfolio-updates/old-portfolio.png)</div>
  <div className="sm:p-1">![New Portfolio](/static/images/writing/portfolio-updates/new-portfolio.png)</div>
</div>
