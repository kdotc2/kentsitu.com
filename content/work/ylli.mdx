...
<div>
  ...
  <div className="-space-y-1">
    - Difficult to share or trade food items - Forgetful of what items exist at home - Uncertain of
    item expiration without expiration labels - Hard to keep track of spend for wasted items -
...
<div>
  ...
  <div className="-space-y-1">
    - Write grocery list items down on phone or paper - Rarely spend time checking inventory, just
    go out and buy - Use credit card statements to keep track of budget
  </div>
</div>
