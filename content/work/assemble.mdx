...
image: /static/images/work/assemble/cover-photo.png
---
...
<div className="py-4">![Process](/static/images/work/assemble/process.png)</div>
...
<div className="py-4">![Additional research](/static/images/work/assemble/research.png)</div>
...
![Survey question one](/static/images/work/assemble/question1.png)

![Survey question two](/static/images/work/assemble/question2.png)

![Survey question three](/static/images/work/assemble/question3.png)
...
<div className="py-8">![Priorities map](/static/images/work/assemble/priority-map.png)</div>
...
<div className="py-4">![Task flow](/static/images/work/assemble/task-flow.png)</div>
...
<div className="projectImageGrid">
    ...
    ![Discover screen](/static/images/work/assemble/wireframe1.png)
  
    ![Create event screen](/static/images/work/assemble/wireframe2.png)
  
    ![Select location screen](/static/images/work/assemble/wireframe3.png)
  
    ![Select time screen](/static/images/work/assemble/wireframe4.png)
  
    ![Invite users screen](/static/images/work/assemble/wireframe5.png)
  
    ![Completed event creation screen](/static/images/work/assemble/wireframe6.png)
  
    ![Events screen](/static/images/work/assemble/wireframe7.png)

    ![Expanded events screen](/static/images/work/assemble/wireframe8.png)
...
<div className="projectImageGrid">
    ...
    ![Search screen](/static/images/work/assemble/search1.png)

    ![Friends + events + peoples filter screen](/static/images/work/assemble/search2.png)

    ![Friends + events filter screen](/static/images/work/assemble/search3.png)

    ![Friends + people filter screen](/static/images/work/assemble/search4.png)
...
<div className="md:pt-4">![Home updates](/static/images/work/assemble/updates1.png)</div>

<div>![Create an event updates](/static/images/work/assemble/updates2.png)</div>

<div>![View event updates](/static/images/work/assemble/updates3.png)</div>

<div className="pb-4">![Share event updates](/static/images/work/assemble/updates4.png)</div>
...
<div className="py-4">![Tests results](/static/images/work/assemble/test-results.png)</div>
...
<div className="py-4">![Design components](/static/images/work/assemble/components.png)</div>
...
<div className="keyTakeaways">
  ...
   Each project has different goals and resources. Figure out what's important and prioritize
  process around the situation.
</div>
...
<div className="keyTakeaways">
  3. <span className="font-semibold">Compromising is very important.</span> Things will not always
  go as planned, prepare to compromise. Remember to consider both the user and the client's needs.
</div>
